...
/// @{
/** \defgroup GazeboThrusterConroller Plugin XML Reference and Example
...
{
  /// \brief Constructor
  public: GazeboThrusterConroller();

  /// \brief Destructor
  public: virtual ~GazeboThrusterConroller();
  ...
  private: void UpdateObjectAccel(const geometry_msgs::Twist::ConstPtr& _msg);
